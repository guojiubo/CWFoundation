...
static NSString *const CWDataCacheDirectoryName = @"com.cocoawind.CWObjectCache";
...
- (id)init
{
    ...
    if (self) {
        ...
        _ioQueue = dispatch_queue_create("com.cocoawind.CWObjectCache", DISPATCH_QUEUE_SERIAL);
